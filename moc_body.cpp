...
static const char qt_meta_stringdata_Body[] = {
    "Body\0\0end(int)\0,,\0play(int,int,int)\0"
    "sweep_xy(int)\0"
};
...
void Body::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->play((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3]))); break;
        case 2: _t->sweep_xy((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject Body::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Body,
