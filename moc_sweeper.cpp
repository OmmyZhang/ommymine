...
static const char qt_meta_stringdata_sweeper[] = {
    "sweeper\0\0xy\0sweep_xy(int)\0"
};
...
void sweeper::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->sweep_xy((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData sweeper::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject sweeper::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_sweeper,
      qt_meta_data_sweeper, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &sweeper::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_sweeper))
